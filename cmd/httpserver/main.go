...
func proxyHandler(w *response.Writer, req *request.Request) {
	...
	h.Replace("Trailer", "X-Content-SHA256, X-Content-Length")
	...
	trailers.Replace("X-Content-SHA256", sha256)
	trailers.Replace("X-Content-Length", fmt.Sprintf("%d", len(fullBody)))
